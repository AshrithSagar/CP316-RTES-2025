...
\begin{tikzpicture}[
  ...
  % System interations
  \node (mic_input) [right=of mic] {Voice commands};
  \node (light_input) [right=of light] {Line};
  \node (ultra_input) [right=of ultra] {Obstacles};
  \node (motor_input) [right=of motor] {Robot movement};
  \node (radio_input) [right=of radio] {Shell};
