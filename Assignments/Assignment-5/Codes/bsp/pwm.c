...
#define PWM_EVENTS_SEQ0END                                                     \
  IOREG32(0x4001C110)                  // event to indicate sequnce 0 ended
#define PWM_ENABLE IOREG32(0x4001C500) // enable / disable pwm
#define PWM_COUNTERTOP                                                         \
  IOREG32(0x4001C508)                     // to decide PWM frequncy
...
#define PWM_SEQ0REFRESH                                                        \
  IOREG32(0x4001C528) // additional pwm cycles between two
