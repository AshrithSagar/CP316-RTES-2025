...
__attribute__((section(".isr_vector"))) pfn_t vector_table[] = {
    /* Core exceptions */
    ...
    RADIO_IRQHandler, UARTE0_UART0_IRQHandler,
    ...
    GPIOTE_IRQHandler, SAADC_IRQHandler, TIMER0_IRQHandler,
...
static void crt_init(void) {
    ...
    src = &__data_load__;
    dst = &__data_start__;
    while (dst < &__bss_start__) *dst++ = *src++;
